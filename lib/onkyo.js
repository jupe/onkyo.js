...
var Onkyo = function(options)
{
  ...
  this.broadcastAddress =
    (typeof this.options.broadcastAddress != "undefined") ? this.options.broadcastAddress : "192.168.0.255";
  this.reqCallback;
  this.detectedDevice;
  this.client;
  ...
  this.server.on("message", function (msg, rinfo) {
    ...
    if( self.detectedDevice ){
      ...
      reqCallback(null, self.detectedDevice);
...
modules.exports.init = function(opts) {
