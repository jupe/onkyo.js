...
{
  var groups = [];
  groups.push.apply( Object.keys(POWER) );
  groups.push.apply( Object.keys(AUDIO) );
  groups.push.apply( Object.keys(SOURCE_SELECT) );
  groups.push.apply( Object.keys(SOUND_MODES) );
  groups.push.apply( Object.keys(SPEAKER_AB_CONTROL) );
  return groups;
}
